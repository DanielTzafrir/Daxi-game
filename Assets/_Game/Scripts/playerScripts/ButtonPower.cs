...
public class ButtonPower : MonoBehaviour
{
    ...
    // [SerializeField] private Image powerMask;
...
public void useBoard()
   ...
   IEnumerator waitShield()
    ...
    IEnumerator gumOn()
    {
        ...
        Debug.Log("finish gum in buttom power");
    }
    ...
    // public void maskPower()
    // {
    //     powerMask.enabled = true;
    //     powerMask.sprite = power.image.sprite;
    //     powerMask.fillAmount = 0f;
